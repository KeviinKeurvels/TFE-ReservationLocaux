import {
  ...
  IonSegmentButton, IonLabel,IonButton, IonRow, IonCol, IonModal, IonItem, IonList, IonSelect, IonSelectOption
} from '@ionic/react';
...
import { handleSubmitUnavailable, handleSubmitAddRoom, handleSubmitDeleteRoom, handleSubmitModifyRoom,
   handleChangeImplantation, handleChangeRoom } from '../../functions/AdministrationRoom/AdministrationRoom'
